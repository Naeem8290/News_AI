...
const LiveSearch = () => {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-md backdrop-blur-3xl bg-white/30 border border-white/40 shadow-lg"
      ref={searchRef}
    >
      <TextInput
        radius={10}
      ...
      />
      {dropdown && (
        <div className="absolute p-2 mt-2 max-h-[300px] overflow-y-scroll text-black bg-white w-full shadow rounded-sm">
          {loading ? (
