...
const AboutUs = () => {
  ...
  return (
    <div className='w-192 ml-10 leading-loose'>
        ...
        <p>🌐 Diverse Sources: We gather news from multiple leading platforms.</p>
        <p>🤖 AI-Powered Curation: Content is intelligently selected and summarized for quick reading.</p>
        <p>⚡ Real-Time Updates: Get the latest stories as they happen.</p>
        <p>🎯 Personalized Feed: News tailored to what matters most to you.</p>

        <p>Our mission is to make staying updated smarter, simpler, and faster. 
